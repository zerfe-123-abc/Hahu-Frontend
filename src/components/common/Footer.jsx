    ...
    <footer className="bg-gray-900 text-gray-100 border-t border-gray-800">
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          {/* About */}
          <div>
            <h3 className="text-lg font-semibold text-white mb-2">HAHU MARKET</h3>
          ...
          {/* Categories */}
          <div>
            <h4 className="text-md font-semibold text-white mb-2">Categories</h4>
            <ul className="space-y-1 text-gray-400 text-sm">
        ...
        {/* Bottom */}
        <div className="mt-6 pt-4 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500 gap-3">
